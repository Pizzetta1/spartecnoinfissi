    ...
    <main className="flex flex-col text-[#0A0A0A] selection:bg-black selection:text-white">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        {/*
          ...
          <img src="/images/scale-hero.jpg" className="w-full h-full object-cover" alt="Scale in legno su misura" />
        */}
        <img
  src="/scalepage.png"
        ...
        <section className="py-44 px-6 border-t border-black/5">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
            ...
            <FadeIn delay={0.1}>
              {/*
                → Sostituire con:
                <img src="/images/scale-intro.jpg" className="w-full h-[500px] object-cover rounded-2xl" alt="Scala in legno su misura" />
              */}
              <img
  src="/scalepage2.png"
                ...
                <FadeIn key={i} delay={i * 0.1}>
                  <div className="grid md:grid-cols-2 gap-0 border-t border-black/10 py-16 items-center">
                    ...
                    <div className={i % 2 === 0 ? "" : "md:order-1"}>
                      {/*
                        → Sostituire con:
                        <img src={`/images/scala-${t.num}.jpg`} className="w-full h-[340px] object-cover rounded-2xl" alt={t.title} />
                      */}
                      <img
...
/>
              ...
              {[
                ...
                <FadeIn key={i} delay={i * 0.15}>
                  <div className="relative h-[380px] overflow-hidden rounded-xl group cursor-pointer">
                    {/*
                      → Sostituire con:
                      <img src={`/images/scale-lavoro-${i+1}.jpg`} className="w-full h-full object-cover transition duration-[1400ms] ease-out group-hover:scale-110 group-hover:-translate-y-2" alt={item.title} />
                    */}
        ...
        <section className="bg-[#0A0A0A] text-white py-44 text-center relative overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.08),transparent_60%)]"></div>
          <FadeIn>
            <h2 className="text-4xl font-serif">Progettiamo la tua scala</h2>
            ...
            <div className="mt-10">
              <MagneticButton>
                <Link href="/contatti" className="relative inline-block overflow-hidden px-10 py-4 border border-white group">
                  <span className="relative z-10 transition duration-500 group-hover:tracking-wide">Richiedi un preventivo</span>
                  ...
                  <span className="absolute inset-0 flex items-center justify-center text-black opacity-0 group-hover:opacity-100 transition duration-500 z-10">Richiedi un preventivo</span>
                </Link>
              </MagneticButton>
            </div>
          </FadeIn>
