  ...
  return (
    <main className="flex flex-col text-[#0A0A0A] selection:bg-black selection:text-white">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        {/*
          IMMAGINE HERO ARREDI
          → Sostituire questo <div> con:
          <img src="/images/arredi-hero.jpg" className="w-full h-full object-cover" alt="Arredi su misura" />
        */}
        <img
  src="/arredipage.png"
        ...
        <section className="py-44 px-6 border-t border-black/5">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
            ...
            <FadeIn delay={0.1}>
              {/*
                → Sostituire con:
                <img src="/images/arredi-intro.jpg" className="w-full h-[500px] object-cover rounded-2xl" alt="Arredo su misura" />
              */}
              <img
  src="/arredipage2.png"
                ...
                <FadeIn key={i} delay={i * 0.1}>
                  <div className="grid md:grid-cols-2 gap-0 border-t border-black/10 py-16 items-center">
                    ...
                    <div className={i % 2 === 0 ? "md:pr-20" : "md:order-2 md:pl-20"}>
                      <span className="text-xs tracking-[0.3em] uppercase text-gray-400">{c.num}</span>
                      <h3 className="mt-3 text-3xl font-serif tracking-tight">{c.title}</h3>
                      <p className="mt-5 text-gray-600 font-light leading-relaxed">{c.desc}</p>
                      <p className="mt-4 text-gray-500 text-sm font-light leading-relaxed">{c.detail}</p>
                    </div>

                    <div className={i % 2 === 0 ? "" : "md:order-1"}>
                      {/*
                        → Sostituire con:
                        <img src={`/images/arredi-${c.num}.jpg`} className="w-full h-[340px] object-cover rounded-2xl" alt={c.title} />
                      */}
                      <img
...
/>
              ...
              {materiali.map((m, i) => (
                <FadeIn key={i} delay={i * 0.1}>
                  <div className="group border border-black/10 p-8 rounded-2xl bg-white/50 backdrop-blur-sm transition duration-500 hover:border-black/30 hover:-translate-y-1">
                    ...
                    <p className="mt-4 text-gray-600 text-sm font-light leading-relaxed">{m.desc}</p>
                  </div>
                </FadeIn>
              ))}
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <FadeIn key={i} delay={i * 0.15}>
                  <div className="relative h-[380px] overflow-hidden rounded-xl group cursor-pointer">
                    {/*
                      → Sostituire con:
                      <img src={`/images/arredi-lavoro-${i+1}.jpg`} className="w-full h-full object-cover transition duration-[1400ms] ease-out group-hover:scale-110 group-hover:-translate-y-2" alt={item.title} />
                    */}
                    ...
                    <div className="absolute bottom-0 left-0 p-6 text-white">
                      <h3 className="text-xl font-serif translate-y-4 group-hover:translate-y-0 transition duration-700 ease-out">{item.title}</h3>
        ...
        <section className="bg-[#0A0A0A] text-white py-44 text-center relative overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.08),transparent_60%)]"></div>
          <FadeIn>
            <h2 className="text-4xl font-serif">Progettiamo insieme il tuo arredo</h2>
            ...
            <div className="mt-10">
              <MagneticButton>
                <Link href="/contatti" className="relative inline-block overflow-hidden px-10 py-4 border border-white group">
                  <span className="relative z-10 transition duration-500 group-hover:tracking-wide">Richiedi un sopralluogo</span>
                  ...
                  <span className="absolute inset-0 flex items-center justify-center text-black opacity-0 group-hover:opacity-100 transition duration-500 z-10">Richiedi un sopralluogo</span>
                </Link>
              </MagneticButton>
            </div>
          </FadeIn>
